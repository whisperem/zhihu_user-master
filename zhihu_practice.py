...
def get_follow_num_page():
    ...
    url_follow_num = 'https://www.zhihu.com/api/v4/questions/28434997/followers?include=data%5B*%5D.gender%2Canswer_count%2Carticles_count%2Cfollower_count%2Cis_following%2Cis_followed&limit=10&offset=0'
